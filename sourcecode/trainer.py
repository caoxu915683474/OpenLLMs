...
class Trainer:
    ...
    def _inner_training_loop(
        ...
        print("xxx" * 100)
        print(self._train_batch_size, args.gradient_accumulation_steps, args.world_size)
        print("xxx" * 100)
        ...
        if has_length(train_dataloader):
            ...
            print("num_examples", num_train_samples)
            if args.include_tokens_per_second:
                num_train_tokens = self.num_tokens(train_dataloader, args.max_steps) * args.gradient_accumulation_steps
                print("num_train_tokens", num_train_tokens)
        else:
            raise ValueError(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    print("total_batched_samples", total_batched_samples, step)
                    model.zero_grad()
